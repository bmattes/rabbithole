# App Store Listing — Hops: Daily Word Puzzle

## Title
Hops: Daily Word Puzzle
...
· Beautifully written narratives that explain your path after you solve it
· Clean, minimal design inspired by the games you already love
· No ads. No timers. Just the puzzle.

If you love Wordle, Connections, or Six Degrees of Kevin Bacon — you'll love Hops.

## Keywords (100 chars)
`word,puzzle,daily,connections,trivia,quiz,brain,knowledge,six degrees,word game,connect`

## Notes
- Subtitle alt: "Connect Any Two Things" (22 chars) — clearer but less punchy
- App Store ID to confirm before launch: id6741993022 (placeholder — verify in App Store Connect)
